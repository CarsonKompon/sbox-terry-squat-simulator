...
namespace TSS
{
	...
	partial class BuffPawn : Player
	{
		...
		[BindComponent] public BuffAnimatorComponent Animator { get; }
		...
		public override void Spawn()
		{
			...
			Components.Create<BuffCamComponent>();
			Components.Create<BuffAnimatorComponent>();
		}
